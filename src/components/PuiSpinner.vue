<template>
  <div class="pui-spinner" v-bind:class="[`pui-spinner--${size}`]">
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="margin:auto;background:#fff;display:block;" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
      <path class="pui-spinner__path" d="M24.3 30C11.4 30 5 43.3 5 50s6.4 20 19.3 20c19.3 0 32.1-40 51.4-40 C88.6 30 95 43.3 95 50s-6.4 20-19.3 20C56.4 70 43.6 30 24.3 30z">
...
.pui-spinner--minor {
  --s-size: #{$spinner-size-minor};
  --s-stroke: #{$spinner-stroke-minor};
}
